...
-- (PDF v4.0 Auditado Premium, 2026-07-15). Idempotente por slug.
...
(values
  ('0e378db0-4675-4eea-b07a-8c4449721d81', 1),
  ('298bcc65-602e-4c00-b28b-c93f84e8422f', 2),
  ('dac52662-9eab-4054-9f86-448b185a1371', 3),
  ('a5c632ae-39ab-4efc-a83f-54c0b7b6c633', 4),
  ('a2284f90-8534-448b-8214-f6030df9a1e6', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('894405ce-5087-4fff-a3c5-cc08244788df', 1),
  ('5c37f9f5-7cc7-409e-a834-d66631e2c05c', 2),
  ('bb333869-66e8-4a33-b4f1-62b41ae6d414', 3),
  ('c68e9900-eeef-4b32-9ce1-ac20646b09d9', 4),
  ('2fa40ac2-d2db-4c7c-a261-e9a06ea16556', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('58f3ef4e-3fca-40b7-a509-2462fb09b723', 1),
  ('62d4ef69-48a8-4c7a-8eb2-060e794bcd31', 2),
  ('52d3e25e-d485-40bf-a4a8-eb497ee3ee7d', 3),
  ('0e7ef242-2d7d-49b5-8bf1-17abb6b97068', 4),
  ('f4b86c34-98df-493f-8890-efa4b2cdd58b', 5),
  ('e6aa59a5-c8c3-441c-903f-eabdc119e264', 6)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('e53dd0d5-31ae-493b-a1c9-50dcb3e81a1b', 1),
  ('2359bbac-c5ba-4c2b-aa3d-e7f4023bb218', 2),
  ('11abf17a-f19d-41b7-b553-56140acc67f8', 3),
  ('5521e94a-d875-4027-92ce-ab050ed41598', 4),
  ('0b72c7ce-ef1f-4710-81f9-77f354613a0c', 5),
  ('439f0002-23ae-46b4-b303-b996f617bb78', 6)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('ab36ffa5-c0db-4362-8f5b-cc49d111215f', 1),
  ('03f42ffe-c035-40bd-bad2-6db6261b5ee4', 2),
  ('7a68ad44-7387-4736-a684-43b95abec3c9', 3),
  ('0622b2ba-d0b2-46d7-a646-ab68aec68e0c', 4),
  ('686f75e5-116e-4e56-9136-021d8a5c850e', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('d9b7e0b4-e82f-46c2-abdc-5cea211030be', 1),
  ('bb873b11-f6a5-4756-9ade-4f6cffe210ea', 2),
  ('0a8a0e4d-0a7f-482b-98ce-4043cf888eaf', 3),
  ('bcf2f23a-4fe1-40fc-8af5-ac41d4bc7e22', 4),
  ('959bc739-91ff-49f9-aa60-c99f073ff2d8', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('4bc150b6-3e3a-4184-902a-9ae23e01dc45', 1),
  ('5521e94a-d875-4027-92ce-ab050ed41598', 2),
  ('580ee02f-f5ea-4a50-8c25-7134997aa4fb', 3),
  ('97aa0957-530e-4be9-9f2e-b276b35bff29', 4)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('d27a6eee-dbbf-4c11-bd29-d4125f267c43', 1),
  ('168b044d-0c91-46b2-965d-dc7ac0490c7a', 2),
  ('4f76c1d9-4318-41bf-98fa-ee1bfadd29c2', 3),
  ('42596162-b762-49aa-875a-ab4af39e4bd7', 4),
  ('127d6410-1ea2-4ca1-874e-29ba5d16844e', 5)
) as v(vid, ord)
...
-- 9. Rutina Acidez y Pesadez Estomacal (simbiótico con Kéfir)
delete from public.kit_products where kit_id = (select id from public.kits where slug = 'rutina-acidez-y-pesadez-estomacal');
insert into public.kit_products (kit_id, variant_id, quantity, sort_order, is_required)
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('e4e9167c-f3fa-422d-88de-057ecffd9619', 1),
  ('15fd1e04-3563-484c-bd62-bf2562fb78c5', 2),
  ('d3e2b891-135d-463b-a0da-afe9c5702c6e', 3),
  ('5ffd287a-d2f0-4207-9473-eeeca12eb860', 4),
  ('a468ddd6-5c29-46d6-8162-8f33b67817b2', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('a07bd2df-76a0-4351-9a59-a464b7d87594', 1),
  ('7a01b22e-cc4a-40d7-9ebc-cb884adde79f', 2),
  ('2f489211-0e4c-4ae5-b0d2-ff4bb6faa41b', 3),
  ('3228b4cd-9599-41ae-b5ef-3d28550ffcce', 4),
  ('1dc49139-2c04-456a-a9fe-2737e5aed3c0', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('0401d28a-c866-416b-906b-105d7e02a3cd', 1),
  ('a0cc5b38-ba49-424d-b829-682266bc3cb3', 2),
  ('8a9feb0b-615b-4717-819d-90ecb16afc4d', 3),
  ('5a64f172-d43c-49f2-b225-0125091a79fa', 4),
  ('43af62cc-19f6-4ee9-88f3-d0f29f32baa4', 5)
) as v(vid, ord)
...
-- 12. Rutina Oficina y Pantallas
delete from public.kit_products where kit_id = (select id from public.kits where slug = 'rutina-oficina-y-pantallas');
insert into public.kit_products (kit_id, variant_id, quantity, sort_order, is_required)
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('f3ca9921-f0d5-49a7-b6a7-56c811f9abbd', 1),
  ('3d023e0b-a977-4804-a11a-fe4fa51d781a', 2),
  ('2c6e6de7-8ace-4b7c-a975-4f030cdc8818', 3),
  ('79ab484a-ed23-491f-8cb2-8b638b2bb6ca', 4),
  ('f8f41b05-a299-473f-bc58-2f708c0fd664', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('7b5a54a5-e19f-467b-bec7-d9820fdfaa60', 1),
  ('24a05620-31e5-4c92-a38a-107cf8384eb7', 2),
  ('f79eaf1b-ab01-4579-ba5b-79bc39565a4e', 3),
  ('84d6d4eb-3233-4aa6-a143-6c4b10ea8e25', 4),
  ('97f4fb2a-0049-496e-86f0-9b2297752e15', 5),
  ('aa07bd6f-53cd-421b-964e-fb5958e0eb9b', 6)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('8649712c-bb88-4e32-a31f-d2494856fba9', 1),
  ('dd01217b-36b7-4c6d-90df-7c55e792e93a', 2),
  ('2c337e39-0bd8-4c49-bdbb-9e4a0e46fefb', 3),
  ('50095527-066b-4bf2-a8d2-a0822d034857', 4),
  ('d7dbc51d-05a7-4661-b97c-57e2dd033161', 5)
) as v(vid, ord)
...
select k.id, v.vid::uuid, 1, v.ord, true from public.kits k,
(values
  ('076dfb77-1ad6-4e9b-9762-d49549ee8dce', 1),
  ('48ca85aa-779d-46a1-a397-ef9ee4d54ac4', 2),
  ('4bb94cac-105d-446a-90da-76b639f67f37', 3),
  ('ac66f2ab-cc48-4aab-ac5d-ce3d1aea1a57', 4)
) as v(vid, ord)
